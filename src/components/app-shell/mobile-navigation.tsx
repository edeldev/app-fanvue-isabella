...
export function MobileNavigation() {
  ...
  const dialog = open ? createPortal(
    <div className="fixed inset-0 z-[100] lg:hidden" role="dialog" aria-modal="true" aria-labelledby={titleId}>
      ...
      <aside id="mobile-navigation" className="relative flex h-dvh w-[min(19rem,86vw)] flex-col overflow-y-auto border-r border-white/10 bg-[#0b0d12] p-4 shadow-2xl shadow-black/70">
