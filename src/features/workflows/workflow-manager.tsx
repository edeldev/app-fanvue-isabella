...
export function WorkflowManager({ workflows, templates, defaults }: { workflows: WorkflowView[]; templates: TemplateOption[]; defaults: WorkflowDefaultsView }) {
...
function translateError(message: string) {
  const errors: Record<string, string> = { WORKFLOW_IMMUTABLE: "Los flujos publicados no se pueden editar.", WORKFLOW_NOT_FOUND: "El flujo no existe.", WORKFLOW_TEMPLATE_NOT_FOUND: "Una plantilla seleccionada no existe.", WORKFLOW_TARGET_NOT_FOUND: "El flujo de destino debe estar publicado y ser principal.", WORKFLOW_IS_RUNNING: "Cancela o finaliza todos los enrollments activos antes de eliminar este workflow.", WORKFLOW_PPV_TEMPLATE_INVALID: "El PPV necesita una plantilla con precio, vista gratuita y al menos un archivo bloqueado.", WORKFLOW_MESSAGE_TEMPLATE_HAS_PRICE: "Enviar mensaje requiere una plantilla sin precio; usa Enviar PPV para contenido de pago." };
