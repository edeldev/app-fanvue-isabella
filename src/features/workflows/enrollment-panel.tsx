...
import { History, Pause, Play, RotateCcw, Trash2, UserPlus, XCircle, Zap } from "lucide-react";
...
export function EnrollmentPanel({ fans, workflows, enrollments, activity, activityCounts }: { fans: FanOption[]; workflows: Pick<WorkflowView, "id" | "name">[]; enrollments: EnrollmentView[]; activity: AutomationLogView[]; activityCounts: { all: number; olderThan90Days: number } }) {
