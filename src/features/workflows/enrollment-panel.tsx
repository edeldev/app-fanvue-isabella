...
import { Pause, Play, RotateCcw, UserPlus, XCircle } from "lucide-react";
import { useRouter } from "next/navigation";
import type { EnrollmentView, FanOption, WorkflowView } from "./types";

export function EnrollmentPanel({ fans, workflows, enrollments }: { fans: FanOption[]; workflows: Pick<WorkflowView, "id" | "name">[]; enrollments: EnrollmentView[] }) {
