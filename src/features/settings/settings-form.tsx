...
export function SettingsForm({ initial }: { initial: GlobalSettingsView }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      enqueueSnackbar("Configuración global guardada.", { variant: "success" }); router.refresh();
    } catch (error) { enqueueSnackbar(error instanceof Error ? error.message : "No se pudo guardar.", { variant: "error" }); }
