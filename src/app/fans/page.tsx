...
export default async function FansPage() {
  ...
  return <div className="flex min-h-screen bg-[#101218] text-zinc-100"><LiveRefresh /><StatusTooltips /><Sidebar /><div className="min-w-0 flex-1"><Topbar /><main id="main-content" tabIndex={-1} className="mx-auto max-w-[1500px] px-4 py-6 sm:px-5 sm:py-8 md:px-8"><div className="mb-8"><p className="mb-2 text-xs font-medium uppercase tracking-[.18em] text-violet-400">CRM</p><h1 className="text-3xl font-semibold tracking-tight text-white">Fans</h1><p className="mt-2 text-sm text-zinc-500">Quiénes son, qué hicieron y qué estrategia sigue cada relación.</p></div>
